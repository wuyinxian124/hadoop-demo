...
import static com.runzhouwu.data.test.MetricsAsserts.getLongCounter;
import static com.runzhouwu.data.test.MetricsAsserts.getMetrics;
...
import com.runzhouwu.data.test.MetricsAsserts;
import com.runzhouwu.data.test.MockitoUtil;
...
public class TestRPC {
    ...
    public static class TestImpl implements TestProtocol {
        ...
        public void testServerGet() throws IOException {
            if (!(RPC.Server.get() instanceof RPC.Server)) {
